 ...
 *  
 *   Params:
 *       Exmple: <a href="#pages/workblog/readmore.html" data-destination="plugin-filter-elements" data-insert="appendTo" data-action="remove">
 *
...
hashDestination.data("destination")&&setTimeout(function(){a(".plugin-filter-elements").mixitup("remix","all")},1E3);"work-items"==hashDestination.data("destination")&&(a(".work-item-details").slideDown(),a("html, body").animate({scrollTop:a(".work-item-details").offset().top-70},1E3));"work-details"==hashDestination.data("destination")&&(a("article").slideDown(),a("html, body").animate({scrollTop:a(".work-details").offset().top-70},1E3));"remove"==hashDestination.data("action")?a(hashDestination).delay(500).slideUp(400,
